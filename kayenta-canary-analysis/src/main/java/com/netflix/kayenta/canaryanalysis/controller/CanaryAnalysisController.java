 ...
 */
@RestController(value = "Canary Analysis Controller - endpoints for performing multiple canary judgements over a period of time, past or present")
@RequestMapping("/canary_analysis")
@Slf4j
public class CanaryAnalysisController {
  ...
  @Autowired
  public CanaryAnalysisController(AccountCredentialsRepository accountCredentialsRepository,
