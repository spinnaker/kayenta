...
@Slf4j
@Data
public class OpentsdbTimeSeries {
    private List<OpentsdbSeriesEntry> series;

    @Data
    static public class OpentsdbSeriesEntry {
        ...
        // Opentsdb returns an array of timestamp/value pairs; the pairs are
