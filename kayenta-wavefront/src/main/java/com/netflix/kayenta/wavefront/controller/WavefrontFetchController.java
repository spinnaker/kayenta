...
public class WavefrontFetchController {
  ...
  public Map queryMetrics(
      ...
      @Parameter(schema = @Schema(defaultValue = "system.cpu.user")) @RequestParam String metricName,
      ...
      @Parameter(description = "The scope of the Wavefront query. e.g. autoscaling_group=myapp-prd-v002")
          @RequestParam(defaultValue = "")
          String scope,
      ...
      @Parameter(description = "An ISO format timestamp, e.g.: 2018-03-15T01:23:45Z") @RequestParam
          String end,
      @Parameter(schema = @Schema(defaultValue = "m"), description = "[s, m, h, d]") @RequestParam String step,
