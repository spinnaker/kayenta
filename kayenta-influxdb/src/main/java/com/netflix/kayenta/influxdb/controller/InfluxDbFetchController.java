...
public class InfluxDbFetchController {
  ...
  public Map<String, String> queryMetrics(
      ...
      @Parameter(schema = @Schema(defaultValue = "temperature")) @RequestParam String metricName,
      @Parameter(description = "Fields that are being queried. e.g. internal, external")
          @RequestParam(required = false)
          List<String> fields,
      @Parameter(description = "The scope of the Influxdb query. e.g. autoscaling_group:myapp-prod-v002")
          @RequestParam(required = false)
          String scope,
