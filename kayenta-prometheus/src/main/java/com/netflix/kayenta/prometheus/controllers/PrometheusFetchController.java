...
public class PrometheusFetchController {
  ...
  public Map queryMetrics(
      ...
      @Parameter(schema = @Schema(defaultValue = "node_cpu")) @RequestParam String metricName,
      ...
      @Parameter(
          ...
          @RequestParam(required = false)
          String scope,
      @Parameter(schema = @Schema(defaultValue = "mode=~\"user|system\"")) @RequestParam(required = false)
