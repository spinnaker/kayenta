...
import com.netflix.kayenta.r.MannWhitneyParams
...
//todo: Remove MannWhitneyClassifierOld from repo...  for debug purposes only

//todo (csanden) rename this classifier
class MannWhitneyClassifierOld(fraction: Double=0.25, confLevel: Double=0.95, mw: MannWhitney) extends BaseMetricClassifier{
