...
public class NewRelicFetchController {
  ...
  public Map queryMetrics(
      ...
      @Parameter(description = "The scope of the NewRelic query. e.g. autoscaling_group:myapp-prod-v002")
      ...
      @Parameter(description = "An ISO format timestamp, e.g.: 2018-03-15T01:23:45Z") @RequestParam
          String end,
      @Parameter(schema = @Schema(defaultValue = "60"), description = "seconds") @RequestParam Long step,
