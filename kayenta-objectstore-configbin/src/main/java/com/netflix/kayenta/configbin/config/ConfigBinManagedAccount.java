...
@SuperBuilder
@NoArgsConstructor
public class ConfigBinManagedAccount extends AccountCredentials<ConfigBinManagedAccount> {
  ...
  @JsonIgnore private transient ConfigBinRemoteService remoteService;
}
